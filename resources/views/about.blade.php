                    ...
                    <div class="col-lg-7">
                        <div class="about-content">
                            ...
                            <p class="description wow pixFadeUp" data-wow-delay="0.4s">
                                Why I say old chap that is spiffing, bite your arm off geeza blag pukka bleeder A bit of
                                how's your father bugger all mate gutted mate, cheesed off hunky-dory gosh morish get
                                stuffed mate lemon squeezy. Bodge barmy bugger no biggie bleeding bits and bobs my good
                                sir, spend a penny faff about are you taking the piss what a plonker bobby bevvy,
                                chancer Eaton me old mucker don't get shirty with me is.
                            </p>
                            ...
                            <div class="singiture wow pixFadeUp" data-wow-delay="0.5s">
                                ...
                                <img src="media/about/sing.png" class="wow pixFadeUp" data-wow-delay="0.6s"
                                    alt="sign">
                            </div>
                            <!-- /.singiture -->
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.5s">
                            ...
                            <div class="pixsass-icon-box-content">
                                <h3 class="pixsass-icon-box-title"><a href="#">New sharing made for people</a>
                                </h3>
                                <p>
                                    The full monty twit cracking goal Jeffrey lurgy chinwag bobby vagabond David, I
                                    don't want no agro what a load.!
                                </p>
                                ...
                                <svg class="layer" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path fill-rule="evenodd" fill="rgb(253, 248, 248)"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.6s">
                            ...
                            <div class="pixsass-icon-box-content">
                                <h3 class="pixsass-icon-box-title"><a href="#">One integrated solution
                                        Manage</a></h3>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.9s">
                            ...
                            <div class="pixsass-icon-box-content">
                                <h3 class="pixsass-icon-box-title"><a href="#">Thousand of features and Custom
                                        option.</a></h3>
                                <p>
                                    The full monty twit cracking goal Jeffrey lurgy chinwag bobby vagabond David, I
                                    don't want no agro what a load.!
        ...
        <section class="testimonials-two-about">
            ...
            <div class="container">
                ...
                <div id="testimonial-wrapper">
                    <div class="swiper-container wow pixFadeUp" data-wow-delay="0.5s" id="testimonial-two"
                        data-speed="700" data-autoplay="5000" data-perpage="2" data-space="50"
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="team-member wow pixFadeRight" data-wow-delay="0.3s">
                            <div class="member-avater">
                                ...
                                <svg class="layer-one" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="370px" height="210px">
                                    <path fill-rule="evenodd" opacity="0.302" fill="rgb(250, 112, 112)"
                                ...
                                <svg class="layer-two" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="370px" height="218px">
                                    <path fill-rule="evenodd" opacity="0.8" fill="rgb(250, 112, 112)"
